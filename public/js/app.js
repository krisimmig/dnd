...
__WEBPACK_IMPORTED_MODULE_1_vue___default.a.component('example-component', __webpack_require__(40));

var Foo = { template: '<div>foo</div>' };
var Bar = { template: '<div>bar</div>' };
var NotFoundComponent = { template: '<div>NotFoundComponent</div>' };
var User = {
    template: '<div>User {{ $route.params.id }}</div>'
};

var routes = [{ path: '/foo', component: Foo }, { path: '/bar', component: Bar }, { path: '/user/:id', component: User }, { path: '*', component: NotFoundComponent }];
